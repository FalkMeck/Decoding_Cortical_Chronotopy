scenario = "Slideshow_D2_eng.sce";
pcl_file = "Slideshow_D2_eng.pcl";
...
text {caption = "Welcome to the last part of the experiment.

Please just remain calm, 
do not move and
do look at the fixation cross."; font_size = 60;} Start_text; # change that it starts automatically?

text {caption = "Nice!\n You are done!"; font_size = $font_text;} End_text;
