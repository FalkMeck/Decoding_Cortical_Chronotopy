# Header
scenario = "RCHS_fMRI.sce";
pcl_file = "RCHS_fMRI.pcl";
...
# progress bar
# borders
box { height = 2; width = 1500; color = 255,255,255; } horiz;
box { height = 100; width = 2; color = 255,255,255; } vert;
box { height = 100; width = 1500; color = 255,255,255;} bar; 


trial {
	trial_duration = 100;
	picture{
		text{caption = "caption"; font_size = 30;}short_break; x = 0; y = 0;
      box horiz; x = 0; y = -350;
      box horiz; x = 0; y = -450;
